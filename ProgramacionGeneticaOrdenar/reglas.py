...
setFun = [
			...
			{ "Name" : "for"  , "NumPar" : 3, "NumSal" : 1, "TypePar":[ ["SET"], ["R"], ["MB"]  ], "Type" : ["MB"]       },
		...
		#	{ "Name" : "=B", "NumPar" : 2, "NumSal" : 1, "TypePar":[ ["MeB"]  ], 		"Type" : ["B"]      },
			...
			{ "Name" : "$AR", "NumPar" : 1, "NumSal" : 1, "TypePar":[ ["R"]  ], "Type" : ["MeR"]  }


		]
InputVar = [{ "Name" : "IPV_"+str(i) , "Type" :["Array"] } for i in xrange(0,numInPutVar) ]
...
Cons= [ { "Name" : 'Cons'+chr(i) , "Type" :["R"], "Val":random.randint( 0,20 ) } for i in xrange(97,97+numVarCon) ]+[ { "Name" : 'ConsB'+chr(i) , "Type" :["B"], "Val": random.choice([True, False]) } for i in xrange(97,97+numVarConB) ]+ [{ "Name" : 'None' , "Type" :["MB"],"Val":"pass" },{ "Name" : 'ConsTAM' , "Type" :["R"], "Val":numInPutVar }] 
